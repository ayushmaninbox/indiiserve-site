import { ServiceDetail, DigitalBrandingService, AIService, AIUseCase, BPMService } from './types';
...
export const bpmData: BPMService = {
    tagline: "Transform Operations. Accelerate Growth. Maximize ROI.",
    title: "Business Process Management (BPM)",
    description: "At Indiiserve.ai, we redesign and automate your core business processes using AI, automation, and performance intelligence — helping you scale faster while reducing costs and inefficiencies.",
    mainFeatures: [
        "AI-first execution model",
        "Measurable ROI & cost efficiency",
        "Rapid deployment",
        "Industry-specific customization",
        "Dedicated transformation experts",
    ],
    services: [
        {
            id: "ipa",
            title: "Intelligent Process Automation (IPA)",
            description: "AI & RPA-driven automation to eliminate repetitive tasks, reduce errors, and improve productivity by up to 60%.",
            features: [
        ...
        {
            id: "lead-sales-mgmt",
            title: "AI-Driven Lead & Sales Process Management",
            description: "Automated lead capture, qualification, CRM integration, and funnel optimization across Meta, Google & LinkedIn.",
            features: [
        ...
        },
        {
            ...
            description: "Omnichannel support (Voice, Email, Chat, WhatsApp) with AI-based quality monitoring and CSAT enhancement.",
            features: [
                "Omnichannel Orchestration",
                "AI Quality Monitoring",
                "CSAT Enhancement Tools",
        ...
        },
        {
            ...
            description: "Real-time dashboards, KPI tracking, cost leakage control, and predictive insights for smarter decisions.",
            features: [
