            ...
            <div className="relative w-full max-w-xl">
                <div className="bg-white/[0.03] backdrop-blur-3xl rounded-[3rem] border border-white/5 shadow-2xl p-10 lg:p-16 relative overflow-hidden group">
                    ...
                    <div className="text-center mb-16 relative z-10">
                        <div className="inline-flex h-20 w-20 items-center justify-center rounded-[2rem] bg-gradient-to-br from-indigo-500 to-violet-600 text-white font-semibold text-4xl shadow-2xl shadow-violet-500/20 mb-8 transition-transform duration-700 hover:rotate-[10deg] hover:scale-110">I</div>
                        <h1 className="text-4xl font-semibold text-white tracking-tight mb-2">Admin Console</h1>
                        <p className="text-[10px] font-semibold text-violet-400/60 uppercase tracking-[0.4em] leading-relaxed">Editorial & Asset Management Node</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                        <div className="space-y-3">
                            <label className="text-[10px] font-semibold text-slate-500 uppercase tracking-[0.2em] ml-1">Identity Vector (Email)</label>
                            <input
                                type="email"
                                value={email}
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-semibold text-slate-500 uppercase tracking-[0.2em] ml-1">Access Key (Password)</label>
                            <input
                                type="password"
                                value={password}
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full mt-6 rounded-[1.5rem] bg-gradient-to-r from-indigo-500 to-violet-600 py-6 font-semibold text-[11px] uppercase tracking-[0.3em] text-white shadow-2xl shadow-violet-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                        >
                    ...
                    <div className="mt-16 pt-12 border-t border-white/5 relative z-10">
                        <div className="flex flex-col gap-6">
                            <h3 className="text-[9px] font-semibold text-slate-600 uppercase tracking-[0.3em]">Credentials Gate:</h3>
                            <div className="grid grid-cols-1 gap-4">
                                <div className="p-6 rounded-3xl bg-white/[0.02] border border-white/5 flex flex-col gap-2 group/trace hover:bg-white/[0.04] transition-colors duration-500">
                                    <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-tight group-hover/trace:text-violet-400/60 transition-colors">Super Admin Hub</p>
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mt-1">
                                        ...
                                        <code className="text-[10px] font-semibold text-violet-400 bg-violet-500/5 px-3 py-1 rounded-full border border-violet-500/10">admin123</code>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mt-10 text-center relative z-10">
                    <button 
                        onClick={() => router.push("/")}
                        className="text-[10px] font-semibold text-slate-600 uppercase tracking-[0.3em] hover:text-violet-400 transition-all duration-300 flex items-center gap-3 mx-auto"
                    >
