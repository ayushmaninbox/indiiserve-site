                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                        <div className="space-y-3 px-2">
                            ...
                            <input
                                ...
                                required
                                className="w-full rounded-2xl border border-white/5 bg-white/[0.02] px-8 py-5 text-sm font-bold text-white outline-none focus:border-violet-500/50 focus:ring-8 focus:ring-violet-500/5 transition-all placeholder:text-slate-700"
                        ...
                        <div className="px-2">
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full rounded-2xl bg-gradient-to-r from-indigo-500 via-violet-600 to-purple-600 py-6 font-semibold text-[11px] uppercase tracking-[0.3em] text-white shadow-2xl shadow-violet-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                            >
