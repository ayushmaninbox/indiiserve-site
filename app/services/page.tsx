...
const mainServices = [
    {
        ...
        description: "Comprehensive digital branding solutions including social media, SEO/AEO, performance marketing, product photography, video editing, and graphic design.",
